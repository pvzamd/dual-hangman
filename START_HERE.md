...
| [RELEASE_READINESS.md](RELEASE_READINESS.md)                 | Pre-deploy review: debt, limitations, risks, doc audit             | Before a deploy, or after a broad review                    | Snapshot review (dated); re-run before shipping                                                           |
| [MUST_FIX_BEFORE_DEPLOY.md](MUST_FIX_BEFORE_DEPLOY.md)       | Blockers for a public deploy (config + DoS safeguard)              | A blocker is resolved or a new one is found                 | **Source of truth: deploy blockers**                                                                      |
| [NICE_TO_HAVE_AFTER_DEPLOY.md](NICE_TO_HAVE_AFTER_DEPLOY.md) | Non-blocking post-launch improvements                              | Items are done or added                                     | Backlog of optional work                                                                                  |
